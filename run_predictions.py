...
def detect_red_light(I):
    ...
    if len(peaks) >= 2 and peaks[1]['peak_heights'] != []:
        ...
        sort_peaks=np.append(sort_peaks,sorted_peaks[0:5])
    if len(peaks1) >= 2 and peaks1[1]['peak_heights'] != []:
        ...
        sort_peaks=np.append(sort_peaks,sorted_peaks1[0:5])
    if len(peaks2) >= 2 and peaks2[1]['peak_heights'] != []:
        ...
        sort_peaks=np.append(sort_peaks,sorted_peaks2[0:5])
    if len(peaks3) >= 2 and peaks3[1]['peak_heights'] != []:
        ...
        sort_peaks=np.append(sort_peaks,sorted_peaks3[0:5])
    if len(peaks4) >= 2 and peaks4[1]['peak_heights'] != []:
        ...
        sort_peaks=np.append(sort_peaks,sorted_peaks4[0:5])
